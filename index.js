...
function writeFileFunction(){
    fs.writeFile("generatedREADME.md","",function(err){
...
function updateFile(response) {
    ...
    fs.appendFileSync("generatedREADME.md", "# " + (response.title || "No Information Given"));

    fs.appendFileSync("generatedREADME.md", "\n\n## Table of Contents"+"\n1. [Description](#description)"+"\n2. [Installation](#installation)" +"\n3. [Usage](#usage)"+"\n4. [License](#license)" + "\n5. [Contributing](#contributing)" + "\n6. [Tests](#tests)" +"\n7. [Questions](#questions)");

    fs.appendFileSync("generatedREADME.md",line,function(err){
        if(err) return console.log(err);
        console.log("File Saved");
    });
}